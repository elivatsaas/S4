...
const dayjsLocale = {
  name: "zh-cn", // Example locale name
  weekdays: ["周日", "周一", "周二", "周三", "周四", "周五", "周六"], // Example weekdays
  // Add other locale configurations as needed
};

const antdLocale = {
  locale: "zh_CN", // Example locale name
  DatePicker: {
    lang: {
      locale: "zh_CN", // Example locale name
    },
...
const Basic = () => {
  ...
  // Define other event handling functions here...
